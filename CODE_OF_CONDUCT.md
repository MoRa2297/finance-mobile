...
Contact [@MoRa2297](https://github.com/MoRa2297) directly via GitHub. Do **not** include vulnerability details in your
first message — just request a secure channel.
...
- Social engineering
- Vulnerabilities in third-party dependencies without a demonstrated exploit in this project's context — report those
  upstream
